...
const getCity = async(req : Request, res : Response) => {
    try{
        const result = await services.CityService.getCity(req.params.id)
        responses.SuccessResponse.data = result;
...
const deleteCity = async(req : Request, res : Response) => {
    try {   
        const result = await services.CityService.deleteCity(req.params.id);
        responses.SuccessResponse.data = result
...
const updateCity = async(req : Request, res : Response) => {
    try {
        const result = await services.CityService.updateCity(req.body);
        responses.SuccessResponse.data = result
